export const highlightedStats = [
  ...
  // { value: '307k+', description: 'Unique Keywords & Tags', hideOnMobile: true },
  // { value: '535k+', description: 'Estimated Words in Questions', hideOnMobile: true },
  // { value: '1.9GB', description: 'Database of Curated Content', hideOnMobile: true },
]; 