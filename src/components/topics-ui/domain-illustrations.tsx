...
export const SummaryIllustration = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 200 160" className={className}>
    <defs>
    ...
    {/* Central hub */}
    <circle cx="100" cy="80" r="25" fill="url(#summaryGrad)" opacity="0.8" />
    
    {/* Connecting lines */}
    <line x1="100" y1="55" x2="100" y2="35" stroke="url(#summaryGrad)" strokeWidth="3" opacity="0.6" />
    <line x1="120" y1="70" x2="140" y2="60" stroke="url(#summaryGrad)" strokeWidth="3" opacity="0.6" />
    <line x1="120" y1="90" x2="140" y2="100" stroke="url(#summaryGrad)" strokeWidth="3" opacity="0.6" />
    <line x1="100" y1="105" x2="100" y2="125" stroke="url(#summaryGrad)" strokeWidth="3" opacity="0.6" />
    <line x1="80" y1="90" x2="60" y2="100" stroke="url(#summaryGrad)" strokeWidth="3" opacity="0.6" />
    <line x1="80" y1="70" x2="60" y2="60" stroke="url(#summaryGrad)" strokeWidth="3" opacity="0.6" />
    
    {/* Outer nodes */}
    <circle cx="100" cy="30" r="10" fill="url(#summaryGrad)" opacity="0.6" />
    <circle cx="145" cy="55" r="10" fill="url(#summaryGrad)" opacity="0.6" />
    <circle cx="145" cy="105" r="10" fill="url(#summaryGrad)" opacity="0.6" />
    <circle cx="100" cy="130" r="10" fill="url(#summaryGrad)" opacity="0.6" />
    <circle cx="55" cy="105" r="10" fill="url(#summaryGrad)" opacity="0.6" />
    <circle cx="55" cy="55" r="10" fill="url(#summaryGrad)" opacity="0.6" />
    
    {/* Pulse animation circles */}
    <circle cx="100" cy="80" r="35" fill="url(#summaryGrad)" opacity="0.2">
      <animate attributeName="r" values="35;40;35" dur="2s" repeatCount="indefinite" />
      <animate attributeName="opacity" values="0.2;0.1;0.2" dur="2s" repeatCount="indefinite" />
    </circle>
    <circle cx="100" cy="80" r="45" fill="url(#summaryGrad)" opacity="0.1">
