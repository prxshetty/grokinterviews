...
function getGradientClasses(domainId: string) {
  const gradients = {
    ai: 'from-purple-500/15 via-purple-500/10 to-purple-500/15 bg-[radial-gradient(circle_at_50%_0%,rgba(147,51,234,0.1),transparent_50%)] dark:from-purple-500/20 dark:via-purple-500/15 dark:to-purple-500/20 dark:bg-[radial-gradient(circle_at_50%_0%,rgba(147,51,234,0.15),transparent_50%)] hover:before:from-purple-400/8 hover:before:via-purple-400/4 hover:before:to-purple-400/8',
    ml: 'from-blue-500/15 via-blue-500/10 to-blue-500/15 bg-[radial-gradient(circle_at_50%_0%,rgba(59,130,246,0.1),transparent_50%)] dark:from-blue-500/20 dark:via-blue-500/15 dark:to-blue-500/20 dark:bg-[radial-gradient(circle_at_50%_0%,rgba(59,130,246,0.15),transparent_50%)] hover:before:from-blue-400/8 hover:before:via-blue-400/4 hover:before:to-blue-400/8',
    sdesign: 'from-green-500/15 via-green-500/10 to-green-500/15 bg-[radial-gradient(circle_at_50%_0%,rgba(16,185,129,0.1),transparent_50%)] dark:from-green-500/20 dark:via-green-500/15 dark:to-green-500/20 dark:bg-[radial-gradient(circle_at_50%_0%,rgba(16,185,129,0.15),transparent_50%)] hover:before:from-green-400/8 hover:before:via-green-400/4 hover:before:to-green-400/8',
    dsa: 'from-orange-500/15 via-orange-500/10 to-orange-500/15 bg-[radial-gradient(circle_at_50%_0%,rgba(249,115,22,0.1),transparent_50%)] dark:from-orange-500/20 dark:via-orange-500/15 dark:to-orange-500/20 dark:bg-[radial-gradient(circle_at_50%_0%,rgba(249,115,22,0.15),transparent_50%)] hover:before:from-orange-400/8 hover:before:via-orange-400/4 hover:before:to-orange-400/8',
    webdev: 'from-indigo-500/15 via-indigo-500/10 to-indigo-500/15 bg-[radial-gradient(circle_at_50%_0%,rgba(99,102,241,0.1),transparent_50%)] dark:from-indigo-500/20 dark:via-indigo-500/15 dark:to-indigo-500/20 dark:bg-[radial-gradient(circle_at_50%_0%,rgba(99,102,241,0.15),transparent_50%)] hover:before:from-indigo-400/8 hover:before:via-indigo-400/4 hover:before:to-indigo-400/8'
  };
