...
import { useState, useEffect, useRef, forwardRef, useCallback, useImperativeHandle, ReactNode } from 'react';
...
const VoicePageWithVisualizer = forwardRef<VoicePageWithVisualizerRef, VoicePageWithVisualizerProps>((
  {
    children,
    isRecording,
    isSpeaking,
