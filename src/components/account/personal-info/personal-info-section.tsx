    ...
    <div className="flex flex-col lg:flex-row gap-4 lg:gap-8">
      ...
      <div className="lg:order-2 w-full lg:w-80 bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-black/80 rounded-xl p-4 lg:p-6 shadow-sm border border-gray-100 dark:border-gray-800 flex flex-col items-center justify-center">
        <div className="relative mb-4 lg:mb-6">
          <div className="w-20 h-20 sm:w-24 sm:h-24 lg:w-32 lg:h-32 rounded-full bg-black dark:bg-white flex items-center justify-center overflow-hidden border-2 lg:border-4 border-white dark:border-gray-800 shadow-lg">
            {profile?.avatar_url ? (
              <Image
              ...
              <div className="text-2xl sm:text-3xl lg:text-4xl font-light text-white dark:text-black">
