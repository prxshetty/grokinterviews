export default function PrivacyPolicy() {
  return (
    <div style={{
      ...
      <p style={{ marginBottom: '1.5rem' }}><strong>Last updated:</strong> {new Date().toLocaleDateString()}</p>

      <section style={{ marginBottom: '1.5rem' }}>
        <h2 style={{ fontSize: '1.5rem', marginBottom: '1rem' }}>1. Introduction</h2>
        <p>Welcome to GrokInterviews ("we," "our," or "us"). This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our AI-powered interview preparation platform and related services (the "Service").</p>
        <p>By using our Service, you agree to the collection and use of information in accordance with this Privacy Policy. If you do not agree with our policies and practices, do not use our Service.</p>
      </section>

      <section style={{ marginBottom: '1.5rem' }}>
        <h2 style={{ fontSize: '1.5rem', marginBottom: '1rem' }}>2. Information We Collect</h2>
        
        <h3 style={{ fontSize: '1.25rem', marginBottom: '0.75rem' }}>2.1 Personal Information</h3>
        ...
        <h3 style={{ fontSize: '1.25rem', marginBottom: '0.75rem', marginTop: '1rem' }}>2.2 Usage and Activity Data</h3>
        ...
        <h3 style={{ fontSize: '1.25rem', marginBottom: '0.75rem', marginTop: '1rem' }}>2.3 Technical Data</h3>
        <ul style={{ marginLeft: '1.5rem' }}>
      ...
      <section style={{ marginBottom: '1.5rem' }}>
        ...
        <h3 style={{ fontSize: '1.25rem', marginBottom: '0.75rem' }}>3.1 Core Service Functionality</h3>
        <ul style={{ marginLeft: '1.5rem' }}>
        ...
        <h3 style={{ fontSize: '1.25rem', marginBottom: '0.75rem', marginTop: '1rem' }}>3.2 Personalization and Analytics</h3>
        <ul style={{ marginLeft: '1.5rem' }}>
        ...
        <h3 style={{ fontSize: '1.25rem', marginBottom: '0.75rem', marginTop: '1rem' }}>3.3 Service Improvement</h3>
        <ul style={{ marginLeft: '1.5rem' }}>
      ...
      <section style={{ marginBottom: '1.5rem' }}>
        <h2 style={{ fontSize: '1.5rem', marginBottom: '1rem' }}>4. Information Sharing and Disclosure</h2>
        
        <h3 style={{ fontSize: '1.25rem', marginBottom: '0.75rem' }}>4.1 Third-Party Services</h3>
        ...
        <ul style={{ marginLeft: '1.5rem' }}>
          ...
          <li><strong>VAPI:</strong> For voice interview features - <a href="https://vapi.ai/privacy" target="_blank" rel="noopener noreferrer" style={{ color: 'blue', textDecoration: 'underline' }}>https://vapi.ai/privacy</a></li>
        </ul>

        <h3 style={{ fontSize: '1.25rem', marginBottom: '0.75rem', marginTop: '1rem' }}>4.2 Legal Requirements</h3>
        <p>We may disclose your information if required by law or in response to valid legal requests.</p>

        <h3 style={{ fontSize: '1.25rem', marginBottom: '0.75rem', marginTop: '1rem' }}>4.3 Business Transfers</h3>
      ...
      <section style={{ marginBottom: '1.5rem' }}>
        <h2 style={{ fontSize: '1.5rem', marginBottom: '1rem' }}>5. Data Storage and Security</h2>
        
        <h3 style={{ fontSize: '1.25rem', marginBottom: '0.75rem' }}>5.1 Data Storage</h3>
        <ul style={{ marginLeft: '1.5rem' }}>
        ...
        <h3 style={{ fontSize: '1.25rem', marginBottom: '0.75rem', marginTop: '1rem' }}>5.2 Security Measures</h3>
        <ul style={{ marginLeft: '1.5rem' }}>
        ...
        <h3 style={{ fontSize: '1.25rem', marginBottom: '0.75rem', marginTop: '1rem' }}>5.3 Data Retention</h3>
        <p>We retain your personal information for as long as your account is active or as needed to provide services. You may request deletion of your account and associated data at any time.</p>
      </section>

      <section style={{ marginBottom: '1.5rem' }}>
        <h2 style={{ fontSize: '1.5rem', marginBottom: '1rem' }}>6. Your Rights and Choices</h2>
        
        <h3 style={{ fontSize: '1.25rem', marginBottom: '0.75rem' }}>6.1 Account Control</h3>
        <ul style={{ marginLeft: '1.5rem' }}>
        ...
        <h3 style={{ fontSize: '1.25rem', marginBottom: '0.75rem', marginTop: '1rem' }}>6.2 Privacy Settings</h3>
        <ul style={{ marginLeft: '1.5rem' }}>
        ...
        <h3 style={{ fontSize: '1.25rem', marginBottom: '0.75rem', marginTop: '1rem' }}>6.3 Communication</h3>
        <p>We currently do not send marketing emails. All communication is service-related and necessary for platform functionality.</p>
      </section>

      <section style={{ marginBottom: '1.5rem' }}>
        <h2 style={{ fontSize: '1.5rem', marginBottom: '1rem' }}>7. Cookies and Tracking</h2>
        ...
        <p>You can control cookies through your browser settings, but disabling them may affect the functionality of our Service.</p>
      </section>
      ...
      <section style={{ marginBottom: '1.5rem' }}>
        <h2 style={{ fontSize: '1.5rem', marginBottom: '1rem' }}>9. International Data Transfers</h2>
      ...
      <section style={{ marginBottom: '1.5rem' }}>
        <h2 style={{ fontSize: '1.5rem', marginBottom: '1rem' }}>10. Changes to This Privacy Policy</h2>
        <p>We may update this Privacy Policy from time to time. We will notify you of any significant changes by posting the new Privacy Policy on this page and updating the "Last updated" date. Your continued use of the Service after any modifications indicates your acceptance of the updated Privacy Policy.</p>
      </section>

      <section style={{ marginBottom: '1.5rem' }}>
        <h2 style={{ fontSize: '1.5rem', marginBottom: '1rem' }}>11. Contact Information</h2>
        ...
        <p>For any questions or to exercise your rights regarding your data, please contact us using the email address above.</p>
      </section>

      <section style={{ marginBottom: '1.5rem', paddingTop: '1.5rem', borderTop: '1px solid #ccc' }}>
        <h2 style={{ fontSize: '1.5rem', marginBottom: '1rem' }}>Summary</h2>
        <div style={{ backgroundColor: '#f5f5f5', padding: '1rem' }}>
          <p style={{ fontWeight: 'bold', marginBottom: '0.5rem' }}>GrokInterviews Privacy Commitment:</p>
