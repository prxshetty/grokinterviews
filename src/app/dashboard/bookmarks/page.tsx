...
const BookmarkCard = ({ bookmark }: { bookmark: Bookmark }) => {
    const Illustration = DOMAIN_ILLUSTRATIONS[bookmark.domain || 'other'] || DOMAIN_ILLUSTRATIONS['other'];
    return (
