      ...
      <div className="prose prose-gray dark:prose-invert max-w-none">
        ...
        <div className="space-y-8">
          <section>
            ...
            <p>
              By accessing and using GrokInterviews ("we," "our," or "us"), you accept and agree to be 
              bound by the terms and provision of this agreement. If you do not agree to these Terms of 
              Service, you may not access or use our service.
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              GrokInterviews is an AI-powered interview preparation platform that provides:
            </p>
          ...
          <section>
            ...
            <p>
              You are solely responsible for your account and the security of your device. We cannot 
          ...
          <section>
            ...
            <p>
              All content available through our service, including but not limited to questions, answers, 
              explanations, resources, text, graphics, logos, and software, is the property of GrokInterviews 
              or its licensors and is protected by copyright, trademark, and other intellectual property laws.
            </p>

            <h3 className="text-xl font-medium mb-3 mt-6">5.2 User Content</h3>
            <p>
              You retain ownership of any content you submit, post, or display through our service. 
            ...
            <p>
              Our service may include content from third parties. We do not control or endorse such 
              content and are not responsible for its accuracy or availability.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We use your data to provide personalized learning experiences, track progress, and 
              improve our service. All data is processed in accordance with applicable data protection laws.
            </p>
          </section>
          ...
          <section>
            ...
            <h3 className="text-xl font-medium mb-3">7.1 Service Access</h3>
            <p>
              We strive to maintain consistent service availability, but we do not guarantee that our 
              service will be available at all times. We may suspend or restrict access to our service 
              at any time for maintenance, updates, or other operational reasons.
            </p>

            <h3 className="text-xl font-medium mb-3 mt-6">7.2 Modifications to Service</h3>
            <p>
              We reserve the right to modify, suspend, or discontinue any part of our service at any 
              time without prior notice. We are not liable for any modification, suspension, or 
              discontinuance of the service.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4">8. Free Service and Limitations</h2>
            <p>
              GrokInterviews is currently provided free of charge. However, we reserve the right to:
            </p>
            <ul className="list-disc pl-6 space-y-1">
            ...
            <p className="mt-4">
              We will provide reasonable notice of any material changes to our pricing structure.
            </p>
          </section>
          ...
          <section>
            ...
            <h3 className="text-xl font-medium mb-3 mt-6">9.2 Educational Purpose</h3>
            <p>
              Our content is for educational and preparation purposes only. We do not guarantee that 
              using our service will result in job offers, interview success, or specific career outcomes.
            </p>

            <h3 className="text-xl font-medium mb-3 mt-6">9.3 Limitation of Liability</h3>
            <p>
              To the maximum extent permitted by law, GrokInterviews shall not be liable for any indirect, 
          ...
          <section>
            ...
            <p className="mt-4">
              These third-party services have their own terms of service and privacy policies. We are 
              not responsible for the terms or practices of these third-party services.
            </p>
          </section>
          ...
          <section>
            ...
            <h3 className="text-xl font-medium mb-3 mt-6">11.2 Termination by Us</h3>
            <p>
            ...
            <h3 className="text-xl font-medium mb-3 mt-6">11.3 Effect of Termination</h3>
            <p>
              Upon termination, all provisions of these Terms which should survive termination shall 
          ...
          <section>
            ...
            <p>
              ...
              of any material changes by posting the new Terms on our website and updating the "Last 
              updated" date.
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              ...
              jurisdiction in which GrokInterviews operates, without regard to conflict of law provisions.
            </p>
          </section>
          ...
          <section className="border-t pt-8 mt-12">
            <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg">
              <p className="font-medium mb-2">By using GrokInterviews, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.</p>
              <p className="text-sm text-muted-foreground">
                These terms are designed to ensure a fair and secure experience for all users while 
                protecting the intellectual property and operational integrity of our platform.
              </p>
            </div>
          </section>
        </div>
